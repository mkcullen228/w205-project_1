// ORM class for table 'visitor_model_atc'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sun Aug 20 21:39:09 UTC 2017
...
public class visitor_model_atc extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("mt_date", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        visitor_model_atc.this.mt_date = (java.sql.Date)value;
      }
    });
    setters.put("visitor_id_hash", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        visitor_model_atc.this.visitor_id_hash = (String)value;
      }
    });
    setters.put("model_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        visitor_model_atc.this.model_id = (Integer)value;
      }
    });
    setters.put("product_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        visitor_model_atc.this.product_id = (Integer)value;
      }
    });
    setters.put("model_atc", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        visitor_model_atc.this.model_atc = (Long)value;
      }
    });
  }
  public visitor_model_atc() {
    init0();
  }
  ...
  public visitor_model_atc with_mt_date(java.sql.Date mt_date) {
    this.mt_date = mt_date;
    return this;
  }
  ...
  public visitor_model_atc with_visitor_id_hash(String visitor_id_hash) {
    this.visitor_id_hash = visitor_id_hash;
    return this;
  }
  ...
  public visitor_model_atc with_model_id(Integer model_id) {
    this.model_id = model_id;
    return this;
  }
  ...
  public visitor_model_atc with_product_id(Integer product_id) {
    this.product_id = product_id;
    return this;
  }
  private Long model_atc;
  public Long get_model_atc() {
    return model_atc;
  }
  public void set_model_atc(Long model_atc) {
    this.model_atc = model_atc;
  }
  public visitor_model_atc with_model_atc(Long model_atc) {
    this.model_atc = model_atc;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof visitor_model_atc)) {
      return false;
    }
    visitor_model_atc that = (visitor_model_atc) o;
    boolean equal = true;
    ...
    equal = equal && (this.model_atc == null ? that.model_atc == null : this.model_atc.equals(that.model_atc));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.model_atc = JdbcWritableBridge.readLong(5, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeLong(model_atc, 5 + __off, -5, __dbStmt);
    return 5;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.model_atc = Long.valueOf(__dataIn.readLong());
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.model_atc) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeLong(this.model_atc);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(model_atc==null?"null":"" + model_atc, delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.model_atc = null; } else {
      this.model_atc = Long.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    visitor_model_atc o = (visitor_model_atc) super.clone();
    o.mt_date = (o.mt_date != null) ? (java.sql.Date) o.mt_date.clone() : null;
    return o;
  }

  public void clone0(visitor_model_atc o) throws CloneNotSupportedException {
    o.mt_date = (o.mt_date != null) ? (java.sql.Date) o.mt_date.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("model_atc", this.model_atc);
