// ORM class for table 'weblog_filtered'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sun Aug 20 21:28:05 UTC 2017
...
public class weblog_filtered extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("utc_datetime", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        weblog_filtered.this.utc_datetime = (java.sql.Timestamp)value;
      }
    });
    setters.put("mt_datetime", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.mt_datetime = (java.sql.Timestamp)value;
      }
    });
    setters.put("utc_time_ms", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.utc_time_ms = (Integer)value;
      }
    });
    setters.put("s_ip", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.s_ip = (String)value;
      }
    });
    setters.put("cs_method", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_method = (String)value;
      }
    });
    setters.put("s_sitename", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.s_sitename = (String)value;
      }
    });
    setters.put("cs_uri_stem", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_uri_stem = (String)value;
      }
    });
    setters.put("s_computername", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.s_computername = (String)value;
      }
    });
    setters.put("cs_uri_query", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_uri_query = (String)value;
      }
    });
    setters.put("cs_user_agent", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_user_agent = (String)value;
      }
    });
    setters.put("s_port", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.s_port = (String)value;
      }
    });
    setters.put("cs_refere", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_refere = (String)value;
      }
    });
    setters.put("cs_host", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_host = (String)value;
      }
    });
    setters.put("sc_status", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.sc_status = (String)value;
      }
    });
    setters.put("sc_win32_status", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.sc_win32_status = (String)value;
      }
    });
    setters.put("sc_bytes", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.sc_bytes = (Long)value;
      }
    });
    setters.put("cs_bytes", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.cs_bytes = (Long)value;
      }
    });
    setters.put("time_taken_ms", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.time_taken_ms = (Long)value;
      }
    });
    setters.put("visitor_id_hash", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.visitor_id_hash = (String)value;
      }
    });
    setters.put("user_agent", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weblog_filtered.this.user_agent = (String)value;
      }
    });
  }
  public weblog_filtered() {
    init0();
  }
  ...
  public weblog_filtered with_utc_datetime(java.sql.Timestamp utc_datetime) {
    this.utc_datetime = utc_datetime;
    return this;
  }
  ...
  public weblog_filtered with_mt_datetime(java.sql.Timestamp mt_datetime) {
    this.mt_datetime = mt_datetime;
    return this;
  }
  ...
  public weblog_filtered with_utc_time_ms(Integer utc_time_ms) {
    this.utc_time_ms = utc_time_ms;
    return this;
  }
  private String s_ip;
  ...
  public weblog_filtered with_s_ip(String s_ip) {
    this.s_ip = s_ip;
    return this;
  }
  ...
  public weblog_filtered with_cs_method(String cs_method) {
    this.cs_method = cs_method;
    return this;
  }
  ...
  public weblog_filtered with_s_sitename(String s_sitename) {
    this.s_sitename = s_sitename;
    return this;
  }
  ...
  public weblog_filtered with_cs_uri_stem(String cs_uri_stem) {
    this.cs_uri_stem = cs_uri_stem;
    return this;
  }
  ...
  public weblog_filtered with_s_computername(String s_computername) {
    this.s_computername = s_computername;
    return this;
  }
  ...
  public weblog_filtered with_cs_uri_query(String cs_uri_query) {
    this.cs_uri_query = cs_uri_query;
    return this;
  }
  ...
  public weblog_filtered with_cs_user_agent(String cs_user_agent) {
    this.cs_user_agent = cs_user_agent;
    return this;
  }
  ...
  public weblog_filtered with_s_port(String s_port) {
    this.s_port = s_port;
    return this;
  }
  private String cs_refere;
  public String get_cs_refere() {
    return cs_refere;
  }
  public void set_cs_refere(String cs_refere) {
    this.cs_refere = cs_refere;
  }
  public weblog_filtered with_cs_refere(String cs_refere) {
    this.cs_refere = cs_refere;
    return this;
  }
  ...
  public weblog_filtered with_cs_host(String cs_host) {
    this.cs_host = cs_host;
    return this;
  }
  ...
  public weblog_filtered with_sc_status(String sc_status) {
    this.sc_status = sc_status;
    return this;
  }
  ...
  public weblog_filtered with_sc_win32_status(String sc_win32_status) {
    this.sc_win32_status = sc_win32_status;
    return this;
  }
  ...
  public weblog_filtered with_sc_bytes(Long sc_bytes) {
    this.sc_bytes = sc_bytes;
    return this;
  }
  ...
  public weblog_filtered with_cs_bytes(Long cs_bytes) {
    this.cs_bytes = cs_bytes;
    return this;
  }
  ...
  public weblog_filtered with_time_taken_ms(Long time_taken_ms) {
    this.time_taken_ms = time_taken_ms;
    return this;
  }
  ...
  public weblog_filtered with_visitor_id_hash(String visitor_id_hash) {
    this.visitor_id_hash = visitor_id_hash;
    return this;
  }
  ...
  public weblog_filtered with_user_agent(String user_agent) {
    this.user_agent = user_agent;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof weblog_filtered)) {
      return false;
    }
    weblog_filtered that = (weblog_filtered) o;
    boolean equal = true;
    ...
    equal = equal && (this.cs_refere == null ? that.cs_refere == null : this.cs_refere.equals(that.cs_refere));
    ...
    equal = equal && (this.user_agent == null ? that.user_agent == null : this.user_agent.equals(that.user_agent));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.cs_refere = JdbcWritableBridge.readString(12, __dbResults);
    ...
    this.user_agent = JdbcWritableBridge.readString(20, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(cs_refere, 12 + __off, 12, __dbStmt);
    ...
    JdbcWritableBridge.writeString(user_agent, 20 + __off, 12, __dbStmt);
    return 20;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.cs_refere = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.cs_host = null;
    } else {
    ...
    this.user_agent = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.cs_refere) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, cs_refere);
    }
    ...
    if (null == this.user_agent) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, user_agent);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(cs_refere==null?"null":cs_refere, delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(user_agent==null?"null":user_agent, delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.cs_refere = null; } else {
      this.cs_refere = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.user_agent = null; } else {
      this.user_agent = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    weblog_filtered o = (weblog_filtered) super.clone();
  ...
  public void clone0(weblog_filtered o) throws CloneNotSupportedException {
    o.utc_datetime = (o.utc_datetime != null) ? (java.sql.Timestamp) o.utc_datetime.clone() : null;
    o.mt_datetime = (o.mt_datetime != null) ? (java.sql.Timestamp) o.mt_datetime.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("cs_refere", this.cs_refere);
    ...
    __sqoop$field_map.put("user_agent", this.user_agent);
